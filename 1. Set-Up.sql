...
Data used: an dataset containing data scrapped from Kickstarted website at the begining of 2018
...
-- adjusting settings to be able to import local file
SHOW GLOBAL VARIABLES LIKE 'local_infile';
SET GLOBAL local_infile = true;

-- loading the Kickstarter dataset

LOAD DATA LOCAL INFILE 'C:\\Users\\laimi\\Desktop\\SQL\\Projects\\Kickstarter\\project_info.csv' INTO TABLE project_info
FIELDS TERMINATED BY ',' LINES TERMINATED BY '\r\n' IGNORE 1 LINES;

LOAD DATA LOCAL INFILE 'C:\\Users\\laimi\\Desktop\\SQL\\Projects\\Kickstarter\\pledge.csv' INTO TABLE pledge
FIELDS TERMINATED BY ',' LINES TERMINATED BY '\r\n' IGNORE 1 LINES;

-- loading country name - country code reference table
...
update project_info
set launched = str_to_date(launched, '%d/%m/%Y %H:%i');

update project_info
set deadline = str_to_date(deadline, '%d/%m/%Y');